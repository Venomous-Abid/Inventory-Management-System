      ...
      <div class="col-md-6 col-lg-4">
          ...
          <div>
              <div class="profile-photo">
                  <img alt="User photo" src="/staff_photo/{{ $staff->image }}" />
              </div>
              <div class="user-header-info">
                  <h4 class="user-name">{{ $staff->user->name }}</h4>
                  <h5 class="user-position">{{ $staff->access_level }}</h5>
          ...
          <div class="panel bg-scale-0 b-primary bt-sm mt-xl">
              <div class="panel-content">
                  ...
                  <ul class="user-contact-info ph-sm">
                      <li><b><i class="color-primary mr-sm fa fa-envelope"></i></b> {{ $staff->user->email }}</li>
                      <li><b><i class="color-primary mr-sm fa fa-phone"></i></b> {{ $staff->phone }}</li>
                      <li><b><i class="color-primary mr-sm fa fa-globe"></i></b> {{ $staff->address }}</li>
                  </ul>
              </div>
          </div>
          <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
