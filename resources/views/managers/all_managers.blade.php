...
<div class="content">
    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                <li><i class="fa fa-user-secret" aria-hidden="true"></i><a href="#">All Manager Page</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <h4 class="section-subtitle">All Manager's  Page</h4>
         <div class="panel">
                  ...
                  <tbody>
                    @foreach($managers as $item)
                      <tr>
                          ...
                          <td>
                            <div class="btn-group">
                                 <a href="{{ route('manager.details',$item->id) }}" class="btn fa fa-eye btn-primary"></a>
                                 <a href="{{ route('manager.edit',$item->id) }}" class="btn fa fa-pencil btn-warning" data-toggle="tooltip" title="Edit"></a>
